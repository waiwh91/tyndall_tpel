...
export async function generateMetadata({params}:Props){const {lang,slug=[]}=await params;const page=slug.join('/');return {title:`${pageTitle(page,lang)} — ${translate('Integrated Power Electronics Team',lang)}`};}
