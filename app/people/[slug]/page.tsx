...
export async function generateMetadata({params}:Props){const {slug}=await params;const member=teamMembers.find(m=>m.slug===slug);return {title:member ? member.name+' — Tyndall Power Electronics Research Team' : 'People'};}
