...
const out=resolve('gh-pages-output'),base='/tyndall_tpel',stylesheet='site-v17.css';
...
for(const [lang] of languages)for(const page of routes){
 ...
 const title=pageTitle(page,lang)+' — '+translate('Tyndall Power Electronics Research Team',lang);
